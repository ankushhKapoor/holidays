...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_lui_ngai_ni(self):
        ...
        self.assertNoHolidayName(name)
        self.assertSubdivMnGovernmentHolidayName(
            name, (f"{year}-02-15" for year in self.full_range)
        )
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; বড়দিনের আগের দিন"),
            ("2018-12-25", "বড়দিন"),
            (
                "2018-12-26",
                "Christmas Festival; জোড় মেলা ফতেহগড় সাহিব; বক্সিং ডে; "
                "বড়দিন-পরবর্তী দিন; লিংরি নিকি সি ডোনি পোলো ইউল্লো; "
                "শহীদ উধম সিংয়ের জন্মজয়ন্তী",
            ),
            (
                "2018-12-27",
                "Christmas Festival; জোড় মেলা ফতেহগড় সাহিব; বড়দিনের পরের দিন (তৃতীয় দিন)",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_gu(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; નાતાલની પૂર્વસંધ્યાએ"),
            ("2018-12-25", "નાતાલ"),
            (
                "2018-12-26",
                "Christmas Festival; ક્રિસમસ પછીનો દિવસ; જોડ મેળો ફતેહગઢ સાહિબ; "
                "બોક્સિંગ ડે; લિંગરી નિકી સી ડોની પોલો યુલ્લો; શહીદ ઊધમ સિંહ જયંતિ",
            ),
            (
                "2018-12-27",
                "Christmas Festival; ક્રિસમસ પછીનો દિવસ (દિવસ 3); જોડ મેળો ફતેહગઢ સાહિબ",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_hi(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; क्रिसमस की पूर्व संध्या"),
            ("2018-12-25", "क्रिसमस"),
            (
                "2018-12-26",
                "Christmas Festival; क्रिसमस के बाद का दिन; जोड़ मेला फतेहगढ़ साहिब; "
                "बॉक्सिंग डे; लिंगरी निकी सी डोनी पोलो युल्लो; शहीद ऊधम सिंह जयंती",
            ),
            (
                "2018-12-27",
                "Christmas Festival; क्रिसमस के बाद का दिन (तीसरा दिन); जोड़ मेला फतेहगढ़ साहिब",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_kn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; ಕ್ರಿಸ್ಮಸ್ ಈವ್"),
            ("2018-12-25", "ಕ್ರಿಸ್‌ಮಸ್"),
            (
                "2018-12-26",
                "Christmas Festival; ಕ್ರಿಸ್ಮಸ್ ನಂತರದ ದಿನ; ಜೋರ್ ಮೇಳಾ ಫತೇಹಗಢ ಸಾಹಿಬ್; "
                "ಬಾಕ್ಸಿಂಗ್ ಡೇ; ಲಿಂಗ್ರಿ ನಿಕಿ ಸೀ ಡೋನಿ ಪೋಲೋ ಯುಲ್ಲೋ; ಶಹೀದ್ ಉದಮ್ ಸಿಂಗ್ ಜಯಂತಿ",
            ),
            (
                "2018-12-27",
                "Christmas Festival; ಕ್ರಿಸ್ಮಸ್ ನಂತರದ ದಿನ (3ನೇ ದಿನ); ಜೋರ್ ಮೇಳಾ ಫತೇಹಗಢ ಸಾಹಿಬ್",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_ml(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; ക്രിസ്മസ് തലേന്ന്"),
            ("2018-12-25", "ക്രിസ്തുമസ്"),
            (
                "2018-12-26",
                "Christmas Festival; ക്രിസ്മസിന് ശേഷമുള്ള ദിവസം; ജോർ മേള ഫതേഹ്ഗഡ് സാഹിബ്; "
                "ബോക്സിംഗ് ഡേ; ലിംഗ്രി നിക്കി സീ ഡോണി പോളോ യൂല്ലോ; ശഹീദ് ഉദം സിംഗ് ജയന്തി",
            ),
            (
                "2018-12-27",
                "Christmas Festival; ക്രിസ്മസിന് ശേഷമുള്ള ദിവസം (മൂന്നാം ദിവസം); ജോർ മേള ഫതേഹ്ഗഡ് സാഹിബ്",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-22", "दत्तात्रेय जयंती"),
            ("2018-12-23", "चौधरी चरण सिंह जयंती"),
            ("2018-12-24", "Christmas Festival; ख्रिसमसच्या पूर्व संध्याकाळ"),
            ("2018-12-25", "ख्रिसमस"),
            (
                "2018-12-26",
                "Christmas Festival; ख्रिसमसनंतरचा दिवस; जोर मेळा फतेहगढ साहिब; "
                "बॉक्सिंग डे; लिंगरी निकी सी डोनी पोलो युल्लो; शहीद उधम सिंह जयंती",
            ),
            (
                "2018-12-27",
                "Christmas Festival; ख्रिसमसनंतरचा दिवस (दिवस 3); जोर मेळा फतेहगढ साहिब",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_pa(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; ਕ੍ਰਿਸਮਿਸ ਦੀ ਪੂਰਵ ਸੰਧਿਆ"),
            ("2018-12-25", "ਕ੍ਰਿਸਮਿਸ ਦਿਵਸ"),
            (
                "2018-12-26",
                "Christmas Festival; ਕ੍ਰਿਸਮਸ ਤੋਂ ਬਾਅਦ ਦਾ ਦਿਨ; ਜੋੜ ਮੇਲਾ ਫਤਿਹਗੜ੍ਹ ਸਾਹਿਬ; "
                "ਬਾਕਸਿੰਗ ਡੇ; ਲਿੰਗਰੀ ਨਿਕੀ ਸੀ ਡੋਨੀ ਪੋਲੋ ਯੁੱਲੋ; ਸ਼ਹੀਦ ਊਧਮ ਸਿੰਘ ਜੀ ਦਾ ਜਨਮ ਦਿਹਾੜਾ",
            ),
            (
                "2018-12-27",
                "Christmas Festival; ਕ੍ਰਿਸਮਸ ਤੋਂ ਬਾਅਦ ਦਾ ਦਿਨ (ਦਿਨ 3); ਜੋੜ ਮੇਲਾ ਫਤਿਹਗੜ੍ਹ ਸਾਹਿਬ",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_ta(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; கிறிஸ்துமஸ் ஈவ்"),
            ("2018-12-25", "கிறிஸ்துமஸ்"),
            (
                "2018-12-26",
                "Christmas Festival; கிறிஸ்துமஸுக்குப் பிந்தைய நாள்; ஜோர் மேளா ஃபதேகர்க் சாஹிப்; "
                "பாக்சிங் டே; லிங்ரி நிகி சீ டோனி போலோ யுல்லோ; ஷஹீத் உதம் சிங் ஜெயந்தி",
            ),
            (
                "2018-12-27",
                "Christmas Festival; கிறிஸ்துமஸுக்குப் பிந்தைய நாள் (நாள் 3); ஜோர் மேளா ஃபதேகர்க் சாஹிப்",
            ),
            (
                "2018-12-28",
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-24", "Christmas Festival; క్రిస్మస్ ఈవ్"),
            ("2018-12-25", "క్రిస్మస్"),
            (
                "2018-12-26",
                "Christmas Festival; క్రిస్మస్ అనంతర దినం; జోర్ మేళా ఫతేహ్‌గఢ్ సాహిబ్; బాక్సింగ్ డే; ",
                "లింగ్రి నికి సీ డోని పోలో యుల్లో; షహీద్ ఉదమ్ సింగ్ జయంతి",
            ),
            ("2018-12-27", "Christmas Festival; క్రిస్మస్ తర్వాతి రోజు (3వ రోజు); జోర్ మేళా ఫతేహ్‌గఢ్ సాహిబ్"),
